...
2.	to use those tools to create some technical documentation about a chosen topic, and deploy it in the form of a website;
3.  to create a report describing the job done.


The topic chosen to fulfill the second goal was *the process of creating technical documentation* itself. In this way, the tehcnical documentation written on this topic and deployed as a website can serve simultaneously as the **final product** of the project and as the **report** of the project, so as to meet the second goal and the third goal of the assignment at the same time. 
